package com.wille.medialibrary.core.books.actions;
...
import com.wille.medialibrary.exception.FileStorageException;
import com.wille.medialibrary.properties.BookStorageProperties;
...
public class FileStorage {
	...
	@Autowired
	public FileStorage(BookStorageProperties booksStorageProperties) {
		this.fileStorageLocation = Paths.get(booksStorageProperties.getUploadDir()).toAbsolutePath().normalize();
